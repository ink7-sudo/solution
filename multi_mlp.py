...
X = np.load('/home/dujunjia/bio/solution/data/multimodal-single-cell-as-sparse-matrix/train_multi_inputs_idxcol.npz', allow_pickle=True)
...
X = pd.read_csv('/home/dujunjia/bio/solution/result/multi_fe/X_164_l2.csv').values
Xt = pd.read_csv('/home/dujunjia/bio/solution/result/multi_fe/Xt_164_l2.csv').values
...
eval_ids = pd.read_parquet("/home/dujunjia/bio/solution/data/multimodal-single-cell-as-sparse-matrix/evaluation.parquet")
...
y_columns = np.load("/home/dujunjia/bio/solution/data/multimodal-single-cell-as-sparse-matrix/train_multi_inputs_idxcol.npz",
                   allow_pickle=True)["columns"]

test_index = np.load("/home/dujunjia/bio/solution/data/multimodal-single-cell-as-sparse-matrix/test_multi_inputs_idxcol.npz",
...
submission.to_csv('/home/dujunjia/bio/solution/result/multi_sub/MLP_submission.csv', index=False)
