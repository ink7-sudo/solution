...
print('modify test')
test_cite_inputs = pd.read_hdf(input_path+'cite_day4_test.h5').reset_index()[['cell_id']]
...
cite_inputs_svd_clr = np.load(feature_path+'day4_cite_inputs_svd_clr_200.npy')
...
cite_inputs_bio_norm_2_svd = np.load(feature_path+'day4_cite_inputs_bio_norm_svd_100.npy')
...
cite_inputs_feats = np.load(feature_path+'day4_cite_inputs_raw_important_feats.npy',allow_pickle=True)  
...
cite_inputs_bio_norm_pca_64 = np.load(feature_path+'day4_cite_inputs_bio_norm_pca_64.npy')
...
np.save(feature_path+'day4_cite_lgb2_svd_100.npy', lgb2_svd)
