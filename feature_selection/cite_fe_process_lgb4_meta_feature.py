...
cite_inputs_sparse = load_npz(feature_path+"day4_cite_inputs_raw_sparse.npz")


train_cite_X = cite_inputs_sparse[:len(train_df)]
test_cite_X = cite_inputs_sparse[len(train_df):]

train_cite_y = pd.read_hdf(input_path+'train_cite_day23_targets_raw.h5').values    
...
np.save(feature_path+'day4_cite_lgb4_svd_100.npy', lgb4_svd)